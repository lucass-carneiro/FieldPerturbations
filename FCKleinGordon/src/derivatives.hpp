 ...
 * Derivative Order: 1    *
 **************************/
#define global_Dx(order, f)                                                                        \
  (J11[ijk] * D##order##x(f) + J21[ijk] * D##order##y(f) + J31[ijk] * D##order##z(f))
#define global_Dy(order, f)                                                                        \
  (J12[ijk] * D##order##x(f) + J22[ijk] * D##order##y(f) + J32[ijk] * D##order##z(f))
#define global_Dz(order, f)                                                                        \
  (J13[ijk] * D##order##x(f) + J23[ijk] * D##order##y(f) + J33[ijk] * D##order##z(f))
