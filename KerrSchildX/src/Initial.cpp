...
extern "C" void KerrSchildX::KerrSchildX_Initial(CCTK_ARGUMENTS) {
  ...
  auto id_lambda = [&](const PointDesc &p) {
    ...
    const CCTK_REAL xformL00 = xform1L00 * xform2L00 + xform1L01 * xform2L10 + xform1L02 * xform2L20
                               + xform1L03 * xform2L30;

    const CCTK_REAL xformL01 = xform1L00 * xform2L01 + xform1L01 * xform2L11 + xform1L02 * xform2L21
                               + xform1L03 * xform2L31;

    const CCTK_REAL xformL02 = xform1L00 * xform2L02 + xform1L01 * xform2L12 + xform1L02 * xform2L22
                               + xform1L03 * xform2L32;

    const CCTK_REAL xformL03 = xform1L00 * xform2L03 + xform1L01 * xform2L13 + xform1L02 * xform2L23
                               + xform1L03 * xform2L33;

    const CCTK_REAL xformL10 = xform1L10 * xform2L00 + xform1L11 * xform2L10 + xform1L12 * xform2L20
                               + xform1L13 * xform2L30;

    const CCTK_REAL xformL11 = xform1L10 * xform2L01 + xform1L11 * xform2L11 + xform1L12 * xform2L21
                               + xform1L13 * xform2L31;

    const CCTK_REAL xformL12 = xform1L10 * xform2L02 + xform1L11 * xform2L12 + xform1L12 * xform2L22
                               + xform1L13 * xform2L32;

    const CCTK_REAL xformL13 = xform1L10 * xform2L03 + xform1L11 * xform2L13 + xform1L12 * xform2L23
                               + xform1L13 * xform2L33;

    const CCTK_REAL xformL20 = xform1L20 * xform2L00 + xform1L21 * xform2L10 + xform1L22 * xform2L20
                               + xform1L23 * xform2L30;

    const CCTK_REAL xformL21 = xform1L20 * xform2L01 + xform1L21 * xform2L11 + xform1L22 * xform2L21
                               + xform1L23 * xform2L31;

    const CCTK_REAL xformL22 = xform1L20 * xform2L02 + xform1L21 * xform2L12 + xform1L22 * xform2L22
                               + xform1L23 * xform2L32;

    const CCTK_REAL xformL23 = xform1L20 * xform2L03 + xform1L21 * xform2L13 + xform1L22 * xform2L23
                               + xform1L23 * xform2L33;

    const CCTK_REAL xformL30 = xform1L30 * xform2L00 + xform1L31 * xform2L10 + xform1L32 * xform2L20
                               + xform1L33 * xform2L30;

    const CCTK_REAL xformL31 = xform1L30 * xform2L01 + xform1L31 * xform2L11 + xform1L32 * xform2L21
                               + xform1L33 * xform2L31;

    const CCTK_REAL xformL32 = xform1L30 * xform2L02 + xform1L31 * xform2L12 + xform1L32 * xform2L22
                               + xform1L33 * xform2L32;

    const CCTK_REAL xformL33 = xform1L30 * xform2L03 + xform1L31 * xform2L13 + xform1L32 * xform2L23
                               + xform1L33 * xform2L33;
    ...
    const CCTK_REAL tdg4011
        = 2 * csetemp14 * M
          * ((3 * csetemp10 - 3 * csetemp11 - csetemp12 - csetemp13) * csetemp22 + 2 * csetemp25
             ...
             + csetemp13
                   * ((csetemp10 + 3 * csetemp11 - csetemp12 - csetemp13) * csetemp24 * rXYZ
    ...
    const CCTK_REAL tdg4013
        = 2 * M * rXYZ
          * ((-2 * csetemp22
              + csetemp10
                    * (2 * (-csetemp10 + csetemp11 + csetemp12 + 2 * csetemp13) * csetemp14
                       - 4 * csetemp28)
    ...
    const CCTK_REAL tdg4022
        = 2 * csetemp14 * M
          * ((3 * csetemp10 - csetemp11 - 3 * csetemp12 - csetemp13) * csetemp22 + 2 * csetemp25
             ...
             + (3 * a * csetemp23 + csetemp15 * csetemp26 - 3 * csetemp13 * csetemp27) * X * Y
             + csetemp13
                   * ((csetemp10 - csetemp11 + 3 * csetemp12 - csetemp13) * csetemp24 * rXYZ
                      - csetemp16 * csetemp26 * X * Y))
          * pow(csetemp10 * csetemp13 + csetemp15, -2) * pow(csetemp10 + csetemp16, -2)
          * pow(4 * csetemp10 * csetemp13 + pow(-csetemp10 + csetemp11 + csetemp12 + csetemp13, 2),
                -0.5);
    ...
    const CCTK_REAL tdg4112
        = 2 * csetemp14 * (csetemp17 + csetemp18) * M
          * (((-2 * csetemp11 - 3 * csetemp12 + 2 * (csetemp10 + csetemp13)) * csetemp15
              + csetemp13 * (6 * csetemp10 - 3 * csetemp12 - 2 * (csetemp11 + csetemp13))
                    * csetemp16)
                 * csetemp26
             + a
                   * ((6 * csetemp10 - 7 * csetemp12 - 2 * (csetemp11 + csetemp13)) * csetemp23
                      + 4 * csetemp29)
             + (-3 * csetemp22 + csetemp10 * csetemp28 + 5 * csetemp13 * csetemp24 * rXYZ) * X * Y
             + csetemp13
                   * ((2 * csetemp10 + csetemp12 - 2 * (csetemp11 + csetemp13)) * csetemp27
    ...
    const CCTK_REAL tdg4121
        = 2 * csetemp14 * M
          * ((a
                  * (2 * (-3 * csetemp10 + 3 * csetemp11 - csetemp12 + csetemp13) * csetemp22
                     - 4 * csetemp25)
              + csetemp26
                    * (2 * csetemp13 * (-3 * csetemp10 + csetemp11 + csetemp12 + csetemp13)
                           * csetemp14
    ...
    const CCTK_REAL tdg4122
        = -2 * csetemp14 * M
          * ((csetemp10 * csetemp15
             ...
             + (-4 * a * csetemp25
                - 2
                      * ((csetemp10 - csetemp11 - csetemp12 + csetemp13) * csetemp26 * csetemp28
                         + (csetemp10 - 3 * csetemp11 + csetemp12 - csetemp13) * csetemp13
                               * csetemp27 * rXYZ))
                   * Y
             + 2
                   * ((csetemp10 * (csetemp10 - 3 * csetemp12 - csetemp13) * csetemp23
    ...
    const CCTK_REAL tdg4123
        = 2 * M * rXYZ
          * ((csetemp11 - csetemp12)
                 * (4 * a * csetemp22
                    + csetemp26
                          * (-2 * (-csetemp10 + csetemp11 + csetemp12 + csetemp13) * csetemp14
                             + 4 * csetemp28))
             + (csetemp10
                    * ((2 * (csetemp11 + csetemp12) + 3 * (csetemp10 + csetemp13)) * csetemp15
                       + 2 * csetemp23)
                + 2 * (csetemp10 - csetemp11 - csetemp12 + 2 * csetemp13) * csetemp16 * csetemp24
                - 3 * csetemp29)
                   * X * Y
             + csetemp13
                   * (4 * (-csetemp11 + csetemp12) * csetemp27 * rXYZ - 3 * csetemp31 * X * Y))
          * Z * pow(csetemp10 * csetemp13 + csetemp15, -2) * pow(csetemp10 + csetemp16, -2)
          * pow(4 * csetemp10 * csetemp13 + pow(-csetemp10 + csetemp11 + csetemp12 + csetemp13, 2),
                -0.5);
    ...
    const CCTK_REAL tdg4133
        = 2 * M
          * ((-((-csetemp10 + csetemp11 + csetemp12 + 4 * csetemp13) * csetemp22) + 2 * csetemp25
              + csetemp10 * csetemp13
                    * ((-csetemp10 + csetemp11 + csetemp12 + 2 * csetemp13) * csetemp14
                       - 3 * csetemp28)
    ...
    const CCTK_REAL tdg4221
        = 2 * csetemp14 * (csetemp19 + csetemp33) * M
          * (((-3 * csetemp11 - 2 * csetemp12 + 2 * (csetemp10 + csetemp13)) * csetemp15
              + csetemp13 * (6 * csetemp10 - 3 * csetemp11 - 2 * (csetemp12 + csetemp13))
                    * csetemp16)
                 * csetemp26
             + a
                   * ((6 * csetemp10 - 7 * csetemp11 - 2 * (csetemp12 + csetemp13)) * csetemp23
                      + 4 * csetemp29)
             + (3 * csetemp22 - csetemp10 * csetemp28 - 5 * csetemp13 * csetemp24 * rXYZ) * X * Y
             + csetemp13
                   * ((2 * csetemp10 + csetemp11 - 2 * (csetemp12 + csetemp13)) * csetemp27
                      - csetemp10 * csetemp14 * X * Y))
          * pow(csetemp10 * csetemp13 + csetemp15, -2) * pow(csetemp10 + csetemp16, -3)
          * pow(4 * csetemp10 * csetemp13 + pow(-csetemp10 + csetemp11 + csetemp12 + csetemp13, 2),
                -0.5);
    ...
    const CCTK_REAL tdg4222
        = 2 * csetemp14 * (csetemp20 + csetemp21) * M
          * ((6 * csetemp10 - 5 * csetemp12 - 2 * (csetemp11 + csetemp13)) * csetemp22
             + 4 * csetemp25
             + csetemp10
                   * (csetemp13 * (6 * csetemp10 - csetemp12 - 2 * (csetemp11 + csetemp13))
                          * csetemp14
                      + (-2 * csetemp11 - csetemp12 + 2 * (csetemp10 + csetemp13)) * csetemp28)
             + (5 * a * csetemp23 + csetemp15 * csetemp26 - 3 * csetemp13 * csetemp27) * X * Y
             + csetemp13
                   * ((2 * csetemp10 + 3 * csetemp12 - 2 * (csetemp11 + csetemp13)) * csetemp24
                          * rXYZ
                      + csetemp16 * csetemp26 * X * Y))
          * pow(csetemp10 * csetemp13 + csetemp15, -2) * pow(csetemp10 + csetemp16, -3)
          * pow(4 * csetemp10 * csetemp13 + pow(-csetemp10 + csetemp11 + csetemp12 + csetemp13, 2),
    ...
    const CCTK_REAL tdg4232
        = -2 * csetemp16 * M
          * ((-3 * csetemp10 + csetemp11 + 4 * csetemp12 + csetemp13) * csetemp22
             ...
             + csetemp13
                   * ((-csetemp10 + csetemp11 - 2 * csetemp12 + csetemp13) * csetemp24 * rXYZ
                      + 2 * csetemp27 * X * Y))
          * Z * pow(csetemp10 * csetemp13 + csetemp15, -2) * pow(csetemp10 + csetemp16, -2)
          * pow(4 * csetemp10 * csetemp13 + pow(-csetemp10 + csetemp11 + csetemp12 + csetemp13, 2),
                -0.5);
          ...
          * (a * ((csetemp10 - csetemp11 - csetemp12 - 5 * csetemp13) * csetemp23 + 2 * csetemp29)
             ...
             + csetemp13
                   * ((-4 * csetemp15
                       + (-csetemp10 + csetemp11 + csetemp12 + csetemp13) * csetemp16)
                          * csetemp26 * X
                      + csetemp10 * (csetemp10 - csetemp11 - csetemp12 - 2 * csetemp13) * csetemp14
                            * Y)
    ...
    const CCTK_REAL dg4000
        = 2
              * ((csetemp114 + csetemp115 + csetemp116 + csetemp117) * xformL20 * xformL30
                 + xformL10
                       * ((csetemp102 + csetemp103 + csetemp104 + csetemp105) * xformL20
    ...
    const CCTK_REAL dg4010
        = xformL10
          ...
          + xformL00
                * ((csetemp82 + csetemp83 + csetemp84 + csetemp85) * xformL01
    ...
    const CCTK_REAL dg4020
        = xformL10
          ...
          + xformL00
                * ((csetemp82 + csetemp83 + csetemp84 + csetemp85) * xformL02
    ...
    const CCTK_REAL dg4030
        = xformL10
          ...
          + xformL00
                * ((csetemp82 + csetemp83 + csetemp84 + csetemp85) * xformL03
    ...
    const CCTK_REAL dg4110
        = 2
              * ((csetemp114 + csetemp115 + csetemp116 + csetemp117) * xformL21 * xformL31
                 + xformL11
                       * ((csetemp102 + csetemp103 + csetemp104 + csetemp105) * xformL21
                          + (csetemp106 + csetemp107 + csetemp108 + csetemp109) * xformL31)
                 + xformL01
    ...
    const CCTK_REAL dg4111
        = 2
              * ((csetemp154 + csetemp155 + csetemp156 + csetemp157) * xformL21 * xformL31
                 + xformL01
                       * ((csetemp126 + csetemp127 + csetemp128 + csetemp129) * xformL11
                          + (csetemp130 + csetemp131 + csetemp132 + csetemp133) * xformL21
                          + (csetemp134 + csetemp135 + csetemp136 + csetemp137) * xformL31)
    ...
    const CCTK_REAL dg4112
        = 2
              * ((csetemp194 + csetemp195 + csetemp196 + csetemp197) * xformL21 * xformL31
                 + xformL01
                       * ((csetemp166 + csetemp167 + csetemp168 + csetemp169) * xformL11
                          + (csetemp170 + csetemp171 + csetemp172 + csetemp173) * xformL21
                          + (csetemp174 + csetemp175 + csetemp176 + csetemp177) * xformL31)
    ...
    const CCTK_REAL dg4113
        = 2
              * ((csetemp234 + csetemp235 + csetemp236 + csetemp237) * xformL21 * xformL31
                 + xformL01
                       * ((csetemp206 + csetemp207 + csetemp208 + csetemp209) * xformL11
                          + (csetemp210 + csetemp211 + csetemp212 + csetemp213) * xformL21
                          + (csetemp214 + csetemp215 + csetemp216 + csetemp217) * xformL31)
    ...
    const CCTK_REAL dg4220
        = 2
              * ((csetemp114 + csetemp115 + csetemp116 + csetemp117) * xformL22 * xformL32
                 + xformL12
                       * ((csetemp102 + csetemp103 + csetemp104 + csetemp105) * xformL22
                          + (csetemp106 + csetemp107 + csetemp108 + csetemp109) * xformL32)
                 + xformL02
    ...
    const CCTK_REAL dg4221
        = 2
              * ((csetemp154 + csetemp155 + csetemp156 + csetemp157) * xformL22 * xformL32
                 + xformL02
                       * ((csetemp126 + csetemp127 + csetemp128 + csetemp129) * xformL12
                          + (csetemp130 + csetemp131 + csetemp132 + csetemp133) * xformL22
                          + (csetemp134 + csetemp135 + csetemp136 + csetemp137) * xformL32)
    ...
    const CCTK_REAL dg4222
        = 2
              * ((csetemp194 + csetemp195 + csetemp196 + csetemp197) * xformL22 * xformL32
                 + xformL02
                       * ((csetemp166 + csetemp167 + csetemp168 + csetemp169) * xformL12
                          + (csetemp170 + csetemp171 + csetemp172 + csetemp173) * xformL22
                          + (csetemp174 + csetemp175 + csetemp176 + csetemp177) * xformL32)
    ...
    const CCTK_REAL dg4223
        = 2
              * ((csetemp234 + csetemp235 + csetemp236 + csetemp237) * xformL22 * xformL32
                 + xformL02
                       * ((csetemp206 + csetemp207 + csetemp208 + csetemp209) * xformL12
                          + (csetemp210 + csetemp211 + csetemp212 + csetemp213) * xformL22
                          + (csetemp214 + csetemp215 + csetemp216 + csetemp217) * xformL32)
    ...
    const CCTK_REAL dg4330
        = 2
              * ((csetemp114 + csetemp115 + csetemp116 + csetemp117) * xformL23 * xformL33
                 + xformL13
                       * ((csetemp102 + csetemp103 + csetemp104 + csetemp105) * xformL23
                          + (csetemp106 + csetemp107 + csetemp108 + csetemp109) * xformL33)
                 + xformL03
    ...
    const CCTK_REAL dg4331
        = 2
              * ((csetemp154 + csetemp155 + csetemp156 + csetemp157) * xformL23 * xformL33
                 + xformL03
                       * ((csetemp126 + csetemp127 + csetemp128 + csetemp129) * xformL13
                          + (csetemp130 + csetemp131 + csetemp132 + csetemp133) * xformL23
                          + (csetemp134 + csetemp135 + csetemp136 + csetemp137) * xformL33)
    ...
    const CCTK_REAL dg4332
        = 2
              * ((csetemp194 + csetemp195 + csetemp196 + csetemp197) * xformL23 * xformL33
                 + xformL03
                       * ((csetemp166 + csetemp167 + csetemp168 + csetemp169) * xformL13
                          + (csetemp170 + csetemp171 + csetemp172 + csetemp173) * xformL23
                          + (csetemp174 + csetemp175 + csetemp176 + csetemp177) * xformL33)
    ...
    const CCTK_REAL dg4333
        = 2
              * ((csetemp234 + csetemp235 + csetemp236 + csetemp237) * xformL23 * xformL33
                 + xformL03
                       * ((csetemp206 + csetemp207 + csetemp208 + csetemp209) * xformL13
                          + (csetemp210 + csetemp211 + csetemp212 + csetemp213) * xformL23
                          + (csetemp214 + csetemp215 + csetemp216 + csetemp217) * xformL33)
    ...
    const CCTK_REAL dbeta11 = betal1 * dgu111 + betal2 * dgu121 + betal3 * dgu131 + dbetal11 * gu11
                              + dbetal21 * gu12 + dbetal31 * gu13;

    const CCTK_REAL dbeta21 = betal1 * dgu121 + betal2 * dgu221 + betal3 * dgu231 + dbetal11 * gu12
                              + dbetal21 * gu22 + dbetal31 * gu23;

    const CCTK_REAL dbeta31 = betal1 * dgu131 + betal2 * dgu231 + betal3 * dgu331 + dbetal11 * gu13
                              + dbetal21 * gu23 + dbetal31 * gu33;

    const CCTK_REAL dbeta12 = betal1 * dgu112 + betal2 * dgu122 + betal3 * dgu132 + dbetal12 * gu11
                              + dbetal22 * gu12 + dbetal32 * gu13;

    const CCTK_REAL dbeta22 = betal1 * dgu122 + betal2 * dgu222 + betal3 * dgu232 + dbetal12 * gu12
                              + dbetal22 * gu22 + dbetal32 * gu23;

    const CCTK_REAL dbeta32 = betal1 * dgu132 + betal2 * dgu232 + betal3 * dgu332 + dbetal12 * gu13
                              + dbetal22 * gu23 + dbetal32 * gu33;

    const CCTK_REAL dbeta13 = betal1 * dgu113 + betal2 * dgu123 + betal3 * dgu133 + dbetal13 * gu11
                              + dbetal23 * gu12 + dbetal33 * gu13;

    const CCTK_REAL dbeta23 = betal1 * dgu123 + betal2 * dgu223 + betal3 * dgu233 + dbetal13 * gu12
                              + dbetal23 * gu22 + dbetal33 * gu23;

    const CCTK_REAL dbeta33 = betal1 * dgu133 + betal2 * dgu233 + betal3 * dgu333 + dbetal13 * gu13
    ...
    const CCTK_REAL kxzL = 0.5 * csetemp314
    ...
    const CCTK_REAL kyzL = 0.5 * csetemp314
