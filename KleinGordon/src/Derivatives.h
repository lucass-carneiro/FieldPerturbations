...
#define D8xy(f)                                                                \
  ((9 * f[I(-4 + i, -4 + j, k)] - 96 * f[I(-4 + i, -3 + j, k)] +               \
    ...
    1024 * f[I(-3 + i, 3 + j, k)] + 96 * f[I(-3 + i, 4 + j, k)] +              \
    504 * f[I(-2 + i, -4 + j, k)] - 5376 * f[I(-2 + i, -3 + j, k)] +           \
    28224 * f[I(-2 + i, -2 + j, k)] - 112896 * f[I(-2 + i, -1 + j, k)] +       \
    112896 * f[I(-2 + i, 1 + j, k)] - 28224 * f[I(-2 + i, 2 + j, k)] +         \
    5376 * f[I(-2 + i, 3 + j, k)] - 504 * f[I(-2 + i, 4 + j, k)] -             \
    2016 * f[I(-1 + i, -4 + j, k)] + 21504 * f[I(-1 + i, -3 + j, k)] -         \
    112896 * f[I(-1 + i, -2 + j, k)] + 451584 * f[I(-1 + i, -1 + j, k)] -      \
    451584 * f[I(-1 + i, 1 + j, k)] + 112896 * f[I(-1 + i, 2 + j, k)] -        \
    21504 * f[I(-1 + i, 3 + j, k)] + 2016 * f[I(-1 + i, 4 + j, k)] +           \
    2016 * f[I(1 + i, -4 + j, k)] - 21504 * f[I(1 + i, -3 + j, k)] +           \
    112896 * f[I(1 + i, -2 + j, k)] - 451584 * f[I(1 + i, -1 + j, k)] +        \
    451584 * f[I(1 + i, 1 + j, k)] - 112896 * f[I(1 + i, 2 + j, k)] +          \
    21504 * f[I(1 + i, 3 + j, k)] - 2016 * f[I(1 + i, 4 + j, k)] -             \
...
#define D8xz(f)                                                                \
  ((9 * f[I(-4 + i, j, -4 + k)] - 96 * f[I(-4 + i, j, -3 + k)] +               \
    ...
    1024 * f[I(-3 + i, j, 3 + k)] + 96 * f[I(-3 + i, j, 4 + k)] +              \
    504 * f[I(-2 + i, j, -4 + k)] - 5376 * f[I(-2 + i, j, -3 + k)] +           \
    28224 * f[I(-2 + i, j, -2 + k)] - 112896 * f[I(-2 + i, j, -1 + k)] +       \
    112896 * f[I(-2 + i, j, 1 + k)] - 28224 * f[I(-2 + i, j, 2 + k)] +         \
    5376 * f[I(-2 + i, j, 3 + k)] - 504 * f[I(-2 + i, j, 4 + k)] -             \
    2016 * f[I(-1 + i, j, -4 + k)] + 21504 * f[I(-1 + i, j, -3 + k)] -         \
    112896 * f[I(-1 + i, j, -2 + k)] + 451584 * f[I(-1 + i, j, -1 + k)] -      \
    451584 * f[I(-1 + i, j, 1 + k)] + 112896 * f[I(-1 + i, j, 2 + k)] -        \
    21504 * f[I(-1 + i, j, 3 + k)] + 2016 * f[I(-1 + i, j, 4 + k)] +           \
    2016 * f[I(1 + i, j, -4 + k)] - 21504 * f[I(1 + i, j, -3 + k)] +           \
    112896 * f[I(1 + i, j, -2 + k)] - 451584 * f[I(1 + i, j, -1 + k)] +        \
    451584 * f[I(1 + i, j, 1 + k)] - 112896 * f[I(1 + i, j, 2 + k)] +          \
    21504 * f[I(1 + i, j, 3 + k)] - 2016 * f[I(1 + i, j, 4 + k)] -             \
...
#define D8yz(f)                                                                \
  ((9 * f[I(i, -4 + j, -4 + k)] - 96 * f[I(i, -4 + j, -3 + k)] +               \
    ...
    1024 * f[I(i, -3 + j, 3 + k)] + 96 * f[I(i, -3 + j, 4 + k)] +              \
    504 * f[I(i, -2 + j, -4 + k)] - 5376 * f[I(i, -2 + j, -3 + k)] +           \
    28224 * f[I(i, -2 + j, -2 + k)] - 112896 * f[I(i, -2 + j, -1 + k)] +       \
    112896 * f[I(i, -2 + j, 1 + k)] - 28224 * f[I(i, -2 + j, 2 + k)] +         \
    5376 * f[I(i, -2 + j, 3 + k)] - 504 * f[I(i, -2 + j, 4 + k)] -             \
    2016 * f[I(i, -1 + j, -4 + k)] + 21504 * f[I(i, -1 + j, -3 + k)] -         \
    112896 * f[I(i, -1 + j, -2 + k)] + 451584 * f[I(i, -1 + j, -1 + k)] -      \
    451584 * f[I(i, -1 + j, 1 + k)] + 112896 * f[I(i, -1 + j, 2 + k)] -        \
    21504 * f[I(i, -1 + j, 3 + k)] + 2016 * f[I(i, -1 + j, 4 + k)] +           \
    2016 * f[I(i, 1 + j, -4 + k)] - 21504 * f[I(i, 1 + j, -3 + k)] +           \
    112896 * f[I(i, 1 + j, -2 + k)] - 451584 * f[I(i, 1 + j, -1 + k)] +        \
    451584 * f[I(i, 1 + j, 1 + k)] - 112896 * f[I(i, 1 + j, 2 + k)] +          \
    21504 * f[I(i, 1 + j, 3 + k)] - 2016 * f[I(i, 1 + j, 4 + k)] -             \
